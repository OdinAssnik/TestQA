...
Функционал: проверка таблчиной части заказа

Как Администратор я хочу
проверить корректность пересчепта суммы при изменении количества ТЧ Номенклатуры в документе Заказ покупателя 
чтобы выставлять корректные суммы покупателю   
